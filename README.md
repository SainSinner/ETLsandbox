...
Тут представлены запросы длля создания коннекта к базе данных, просмотра коннекторов и просмотра статуса коннектора, например.

https://github.com/SainSinner/Request/tree/main/ETLsandbox

## Где лежат скрипты которые я дописывал

### SQL, PySpark, Python

[Скрипты](scripts/ETLsandbox_my_scripts)
